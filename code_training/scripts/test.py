...
TEST_DATA = read_data("../data/val_nofaulty.json")
evaluate_ner_model("../models/best_model", TEST_DATA)
cm, labels = create_ner_confusion_matrix("../models/best_model", TEST_DATA)